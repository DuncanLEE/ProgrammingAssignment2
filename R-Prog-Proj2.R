# this function creates a list of 4 member functions: setmatrix, getmatrix, setInvmatrix and getInvmatrix. 
# the use of <<- assignment operator is conceal internal variables from outside environment. 
